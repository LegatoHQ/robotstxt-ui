...
export const licensesOptions = [
  {
    id: 'CC0 (“PUBLIC”)',
    value: 'https://arweave.net/zmc1WTspIhFyVY82bwfAIcIExLFH5lUcHHUN0wXg4W8/0',
  },
  {
  ...
  {
    id: 'Personal License (“PERSONAL”)',
    value: 'https://arweave.net/zmc1WTspIhFyVY82bwfAIcIExLFH5lUcHHUN0wXg4W8/4',
  },
  {
    ...
    >
      ...
      <Autosuggest
        ...
        inputProps={{
          ...
          placeholder:
            'Select or enter a default license to attach to this address.',
          className:
        ...
        renderSuggestion={(suggestion, { isHighlighted }) => (
          <div
            className={cn('flex flex-col gap-1 px-4 py-2', {
              'bg-black/10 dark:bg-white/20': isHighlighted,
            })}
          >
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col">
          ...
          <div
            className={cn('text-sm font-semibold dark:text-white', {
              'text-red-500 ': !hasEnoughBalanceToWrite,
            })}
          >
