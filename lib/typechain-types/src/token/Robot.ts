...
export interface RobotInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "robotTxt", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "robotTxt", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setRobotTxt",
    data: BytesLike
  ): Result;
...
export interface Robot extends BaseContract {
  ...
  functions: {
    ...
    robotTxt(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    robotTxt(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    robotTxt(overrides?: CallOverrides): Promise<PopulatedTransaction>;
